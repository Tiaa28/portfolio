    ...
    <header className={`${font.className} absolute top-0 w-full`}>
      <div className="container mx-auto py-4  md:px-0 px-4 flex justify-between items-center">
        ...
        <nav className="flex items-center gap-3 md:mx-0 mx-auto md:px-0 px-4 py-4 md:py-0" ref={navLink}>
          <Link href="#" className="text-color-grey font-medium hover:text-color-green">Home</Link>
          <Link href="#" className="text-color-grey font-medium hover:text-color-green">About</Link>
          <Link href="#" className="text-color-grey font-medium hover:text-color-green">Projects</Link>
          <Link href="#" className="text-color-grey font-medium hover:text-color-green">Contact</Link>
        </nav>
