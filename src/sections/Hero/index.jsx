      ...
      <div className="flex flex-col-reverse lg:flex-row justify-center items-center h-full">
        ...
        <div className="w-full md:basis-1/2 basis-full">
          <div className="flex flex-col gap-3 items-start justify-center">
            <p className="font-bold text-color-green text-md">I'am Tia Niandari</p>
            ...
            <Link href={'#'} className='bg-gradient hover:bg-gradient-hover py-2 px-4 text-color-white'>About Me</Link>
          </div>
        </div>
      </div>
    </section>
